		...
		updateDependencyStatus: function updateDependencyStatus() {
			...
			try {
				for (var _iterator2 = this.field.dependencies[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					...
					// compatability with orlyapps/nova-belongsto-depend
					if ((typeof dependencyValue === 'undefined' ? 'undefined' : _typeof(dependencyValue)) === 'object' && dependencyValue != null && dependencyValue.hasOwnProperty('id')) {
						dependencyValue = dependencyValue.id;
					}
